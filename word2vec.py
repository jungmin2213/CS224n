...
def naiveSoftmaxLossAndGradient(
    ...
    hy = softmax(np.dot(outsideVectors, centerWordVec))

    loss = -np.log(hy[outsideWordIdx])

    y = np.zeros_like(hy)

    y[outsideWordIdx] = 1

    gradCenterVec = np.dot(hy - y, outsideVectors)
    gradOutsideVecs = np.outer(hy - y, centerWordVec)
...
def getNegativeSamples(outsideWordIdx, dataset, K):
    """ Samples K indexes which are not the outsigit deWordIdx """
...
def negSamplingLossAndGradient(
    ...
    Arguments/Return Specificationwarning: in the working copy of '.idea/inspectionProfiles/profiles_settings.xml', LF will be replaced by CRLF the next time Git touches it
warning: in the working copy of 'a2/collect_submission.sh', LF will be replaced by CRLF the next time Git touches it
warning: in the working copy of 'a2/env.yml', LF will be replaced by CRLF the next time Git touches it
warning: in the working copy of 'a2/get_datasets.sh', LF will be replaced by CRLF the next time Git touches it
warning: in the working copy of 'a2/run.py', LF will be replaced by CRLF the next time Git touches it
warning: in the working copy of 'a2/sgd.py', LF will be replaced by CRLF the next time Git touches it
warning: in the working copy of 'a2/utils/gradcheck.py', LF will be replaced by CRLF the next time Git touches it
warning: in the working copy of 'a2/utils/treebank.py', LF will be replaced by CRLF the next time Git touches it
warning: in the working copy of 'a2/utils/utils.py', LF will be replaced by CRLF the next time Git touches it
warning: in the working copy of 'a2/word2vec.py', LF will be replaced by CRLF the next time Git touches its: same as naiveSoftmaxLossAndGradient
    """
    ...
    hy = sigmoid(np.dot(outsideVectors[outsideWordIdx], centerWordVec))
    loss = -np.log(hy)

    gradCenterVec = np.dot(hy - 1, outsideVectors[outsideWordIdx])
    gradOutsideVecs[outsideWordIdx] = np.dot(hy - 1, centerWordVec)

    for i in range(K):
        wk = indices[i + 1]
        hyk = sigmoid(-np.dot(outsideVectors[wk], centerWordVec))
        loss += -np.log(hyk)
        gradOutsideVecs[wk] += np.dot(1.0 - hyk, centerWordVec)
        gradCenterVec += np.dot(1.0 - hyk, outsideVectors[wk])
...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    for outsideWord in outsideWords:
        ...
        stepLoss, gradCenter, gradOutsie = word2vecLossAndGradient(centerWordVec, outsideWordIdx, outsideVectors, dataset)
        loss += stepLoss
        gradCenterVecs[centerWordIdx] += gradCenter
        gradOutsideVectors += gradOutsie
    ### END YOUR CODE
